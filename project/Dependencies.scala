...
object Dependencies {
  ...
  val AwsJavaSdkS3: ModuleID = "com.amazonaws" % "aws-java-sdk-s3" % "1.11.493"
  val CommonsCompress: ModuleID = "org.apache.commons" % "commons-compress" % "1.18"
  val JacksonDatabind: ModuleID = "com.fasterxml.jackson.core" % "jackson-databind" % "2.9.8"
  ...
  val S3: ModuleID = "software.amazon.awssdk" % "s3" % "2.4.2"
  ...
  val ZstdJni: ModuleID = "com.github.luben" % "zstd-jni" % "1.3.8-3"
