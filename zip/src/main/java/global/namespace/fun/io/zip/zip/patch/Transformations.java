...
import global.namespace.fun.io.zip.zip.model.EntryNameAndDigest;
import global.namespace.fun.io.zip.zip.model.EntryNameAndTwoDigests;

/**
 * Transforms an object into an
 * {@link global.namespace.fun.io.zip.zip.model.EntryNameAndDigest} by applying
 * some dark magic.
 *
